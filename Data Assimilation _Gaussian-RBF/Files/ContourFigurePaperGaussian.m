...
for i = 1: m1
    ...
    if ismember(i, [50, 100, 150, 200])
        % Create a new subplot
        figure(2); % You may want to use a different figure number
        subplot(4,1,find(i == [50, 100, 150, 200]));
        ...
        title(['Time = ', num2str(i * 0.1), ' sec'], 'FontSize', 10);
        CC = colorbar; % Add a colorbar to the plot
        %CC.Label.String = 'Reconstructed HF (W/m^{2})';
...
filenameFigure2 = 'SnapshotCountorsGaussian.png';
...
%saveas(figure(2), 'SnapshotCountorsGaussian.png', 'png');
%saveas(figure(3), 'SnapshotCountorsTrue.png', 'png', 'Resolution');


print(figure(1), 'ComparisnCountors.png', '-dpng', '-r400'); % Adjust '-r' value as needed for resolution
print(figure(2), 'SnapshotCountorsGaussian.png', '-dpng', '-r400');
print(figure(3), 'SnapshotCountorsTrue.png', '-dpng', '-r400');
