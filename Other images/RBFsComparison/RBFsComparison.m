...
cd('E:\SISSA\000 Ensemble\15 Other images for the paper\RBFsComparison');
currentDir = pwd;
...
print('XZCentersOfFaces.pdf', '-dpdf');
...
dpi = 400; print('GaussianTempG0_5.png', '-dpng', ['-r' num2str(dpi)]);
...
view(45, 30); % Adjust the view angle (optional)
dpi = 400; print('GaussianTempG1.png', '-dpng', ['-r' num2str(dpi)]);
...
CC = colorbar; CC.FontSize = 10 ; CC.FontWeight = 'bold';
view(45, 30); % Adjust the view angle (optional)
dpi = 400; print('GaussianTempG2.png', '-dpng', ['-r' num2str(dpi)]);
...
CC = colorbar; CC.FontSize = 10 ; CC.FontWeight = 'bold';
view(45, 30); % Adjust the view angle (optional)
dpi = 400; print('GaussianTempG2_5.png', '-dpng', ['-r' num2str(dpi)]);
...
CC = colorbar; CC.FontSize = 10 ; CC.FontWeight = 'bold';
view(45, 30); % Adjust the view angle (optional)
dpi = 400; print('MultiquadricTempM0_5.png', '-dpng', ['-r' num2str(dpi)]);
...
CC = colorbar; CC.FontSize = 10 ; CC.FontWeight = 'bold';
view(45, 30); % Adjust the view angle (optional)
dpi = 400; print('MultiquadricTempM1.png', '-dpng', ['-r' num2str(dpi)]);
...
CC = colorbar; CC.FontSize = 10 ; CC.FontWeight = 'bold';
view(45, 30); % Adjust the view angle (optional)
dpi = 400; print('MultiquadricTempM3.png', '-dpng', ['-r' num2str(dpi)]);
...
CC = colorbar; CC.FontSize = 10 ; CC.FontWeight = 'bold';
view(45, 30); % Adjust the view angle (optional)
dpi = 400; print('MultiquadricTempM7_5.png', '-dpng', ['-r' num2str(dpi)]);
%print('MultiquadricTempM7_5.pdf', '-dpdf');



% Read images
img1 = imread('GaussianTempG0_5.png');
img2 = imread('GaussianTempG1.png');
img3 = imread('GaussianTempG2.png');
img4 = imread('GaussianTempG2_5.png');

img5 = imread('MultiquadricTempM0_5.png');
img6 = imread('MultiquadricTempM1.png');
img7 = imread('MultiquadricTempM3.png');
img8 = imread('MultiquadricTempM7_5.png');
...
imwrite(combinedImg1GaussianRBF, 'Combined1.png');
figure;
imshow('Combined1.png');
print('Combined1.pdf', '-dpdf');

% Save the second combined image
imwrite(combinedImg2MultiquadricRBF, 'Combined2.png');
figure;
imshow('Combined2.png');
print('Combined2.pdf', '-dpdf');
